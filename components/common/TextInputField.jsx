...
const TextInputField = React.forwardRef(({ title, placeholder, error, ...rest }, ref) => {
  return (
    <label className="w-full">
      ...
      <input 
        className="bg-primaryColor bg-opacity-10 p-2 w-full lg:placeholder:text-base placeholder:text-sm mt-1 focus:outline-none text-customGrey text-xs lg:text-base" 
        type="text" 
